...
[![GoDoc](https://img.shields.io/static/v1?label=godoc&message=reference&color=blue)](https://pkg.go.dev/github.com/bryancallahan/go-github/v50/github)
...
```bash
go get github.com/bryancallahan/go-github/v50
```
...
```go
import "github.com/bryancallahan/go-github/v50/github"
```
...
```bash
go get github.com/bryancallahan/go-github/v50@master
```

## Usage ##

```go
import "github.com/bryancallahan/go-github/v50/github"	// with go modules enabled (GO111MODULE=on or outside GOPATH)
...
[package docs]: https://pkg.go.dev/github.com/bryancallahan/go-github/v50/github
